...
% Example:
%   [time,pid1,process,LBA,size,type,VarName7,VarName8] =
%   importfile('new',1, 29470);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/08/30 08:43:13
%  [ASU,LBA,size,type,time] = ParseTrace(filename, startRow, endRow)
